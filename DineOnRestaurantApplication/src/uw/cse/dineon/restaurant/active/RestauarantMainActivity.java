...
CurrentCustomersFragment.CustomerListener 
{
	...
	private class ScreenSlidePagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			case 1:
				...
				break;
			default:
				f = CurrentCustomersFragment.newInstance(mCustomers);
			}
	...
	private void addCustomer(String customer){
		...
		if (f != null && f instanceof CurrentCustomersFragment) {
			CurrentCustomersFragment frag = (CurrentCustomersFragment) f;
